                        ...
                        <div class="row">
                            <section class="col-12">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            // Boucle Foreach sur la varible result
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="delete.php?id=<?= $candidat['id'] ?>" class="btn btn-danger mx-1">Supprimer</a>
                                                </td>
                                            </tr>
                                        <?php
                                            }
                                ...
                                <a href="add.php" class="btn btn-primary">Ajouter un candidat</a>
                            </section>
                        </div>
                    </main>
