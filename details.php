                    ...
                    <main>
                        <div class="row">
                            <section class="col-12">
                                <h1>Fiche descriptive du candidat <?= $candidat['nom'] . ' ' . $candidat['prenom']; ?></h1>
                                <p>ID: <?= $candidat['id']; ?></p>
                                ...
                                <p>Code Postal: <?= $candidat['cd_postal']; ?></p>
                                <p>Marchés: <?= $candidat['marches']; ?></p>
                                <p>Technologies: <?= $candidat['technos']; ?></p>
                                <p>
                                    <a href="index.php">Retour</a>
                                    <a href="edit.php?id=<?= $candidat['id']; ?>">Modifier</a>
                                </p>
                            </section>
                        </div>
                    </main>
