...
if($_POST) 
{
    ...
    ) 
    {
        ...
        $_SESSION['message'] = "Profil du candidat ajouté";
        require_once('req/_close.php');
        header('Location: index.php');
    }
    else 
    {
        $_SESSION['erreur'] = 'Le profil du candidat est incomplet';
    };
};
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Addixware</div>
            </a>
                    ...
                    <main class="container">
                        <div class="row">
                            <section class="col-12">
                                ...
                                ?>
                                <h1>Ajouter le profil d'un candidat</h1>
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="cd_postal" name="cd_postal" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="marches">Marchés</label>
                                        <input type="text" id="marches" name="marches" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="technos">Technologies</label>
                                        <input type="text" id="technos" name="technos" class="form-control">
                                    </div>
